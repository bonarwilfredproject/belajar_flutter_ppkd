...
//
//     final ghibliFilm = ghibliFilmFromJson(jsonString);

import 'dart:convert';

List<GhibliFilm> ghibliFilmFromJson(String str) =>
    List<GhibliFilm>.from(json.decode(str).map((x) => GhibliFilm.fromJson(x)));

String ghibliFilmToJson(List<GhibliFilm> data) =>
...
class GhibliFilm {
  ...
  factory GhibliFilm.fromJson(Map<String, dynamic> json) => GhibliFilm(
    id: json["id"],
    title: json["title"],
